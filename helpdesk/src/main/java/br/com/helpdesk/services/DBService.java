...
public class DBService {
    ...
    public void instanciaDB() {
        ...
        Tecnico tec1 = new Tecnico(null, "Gabriel", "550.482.150-95", "valdir@mail.com", encoder.encode("123"));
        ...
        Tecnico tec6 = new Tecnico(null, "joao", "37666549857", "joao@mail.com", encoder.encode("123"));
        Tecnico tec7 = new Tecnico(null, "Emir", "101.299.170-95", "emir@mail.com", encoder.encode("123"));
